...
from torch_geometric.nn import ChebConv, NNConv, DeepGCNLayer, ARMAConv, ClusterGCNConv, GENConv, ARMAConv
...
class MyDeeperGCN(torch.nn.Module):
    def __init__(self, num_node_features, num_edge_features,
        ...
        self.node_encoder = ARMAConv(num_node_features, node_hidden_channels, num_stacks=4, num_layers=4)
